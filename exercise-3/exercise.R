...
care_in_1940 <- US_data['Personal Care', 'X1940']

# How much money was spent on Food and Tobacco in 1960?
food_tobacco_in_1960 <- US_data['Food and Tobacco', 'X1960']

# What was the highest expenditure category in 1960?
highest_in_1960 <- US_data$category[US_data$X1960 == max(US_data$X1960)]
